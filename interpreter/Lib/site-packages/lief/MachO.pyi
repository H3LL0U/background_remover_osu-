...
class BINDING_CLASS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.BINDING_CLASS: ...
    @property
    def value(self) -> int: ...
...
class BIND_OPCODES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.BIND_OPCODES: ...
    @property
    def value(self) -> int: ...
...
class BIND_SPECIAL_DYLIB:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.BIND_SPECIAL_DYLIB: ...
    @property
    def value(self) -> int: ...
...
class BIND_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.BIND_TYPES: ...
    @property
    def value(self) -> int: ...
...
class Binary(lief.Binary):
    ...
    def __contains__(self, arg: lief.MachO.LOAD_COMMAND_TYPES, /) -> bool: ...
    def __getitem__(self, arg: lief.MachO.LOAD_COMMAND_TYPES, /) -> lief.MachO.LoadCommand: ...
    @property
...
class CPU_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.CPU_TYPES: ...
    @property
    def value(self) -> int: ...
...
class EXPORT_SYMBOL_FLAGS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.EXPORT_SYMBOL_FLAGS: ...
    @property
    def value(self) -> int: ...
...
class EXPORT_SYMBOL_KINDS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.EXPORT_SYMBOL_KINDS: ...
    @property
    def value(self) -> int: ...
...
class ExportInfo(lief.Object):
    ...
    flags: int
    def __init__(self, *args, **kwargs) -> None: ...
    def has(self, flag: lief.MachO.EXPORT_SYMBOL_FLAGS) -> bool: ...
    @property
...
class FILE_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.FILE_TYPES: ...
    @property
    def value(self) -> int: ...
...
class HEADER_FLAGS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.HEADER_FLAGS: ...
    @property
    def value(self) -> int: ...
...
class Header(lief.Object):
    ...
    def __contains__(self, arg: lief.MachO.HEADER_FLAGS, /) -> bool: ...
    def __iadd__(self, arg: lief.MachO.HEADER_FLAGS, /) -> lief.MachO.Header: ...
    def __isub__(self, arg: lief.MachO.HEADER_FLAGS, /) -> lief.MachO.Header: ...
    @property
...
class LOAD_COMMAND_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.LOAD_COMMAND_TYPES: ...
    @property
    def value(self) -> int: ...
...
class REBASE_OPCODES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.REBASE_OPCODES: ...
    @property
    def value(self) -> int: ...
...
class REBASE_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.REBASE_TYPES: ...
    @property
    def value(self) -> int: ...
...
class RELOCATION_ORIGINS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.RELOCATION_ORIGINS: ...
    @property
    def value(self) -> int: ...
...
class Relocation(lief.Relocation):
    address: int
    pc_relative: bool
    type: Union[lief.MachO.X86_RELOCATION,lief.MachO.X86_64_RELOCATION,lief.MachO.PPC_RELOCATION,lief.MachO.ARM_RELOCATION,lief.MachO.ARM64_RELOCATION,lief.MachO.REBASE_TYPES,]
    def __init__(self, *args, **kwargs) -> None: ...
    @property
...
class SECTION_FLAGS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.SECTION_FLAGS: ...
    @property
    def value(self) -> int: ...
...
class SECTION_TYPES:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.SECTION_TYPES: ...
    @property
    def value(self) -> int: ...
...
class SYMBOL_ORIGINS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.SYMBOL_ORIGINS: ...
    @property
    def value(self) -> int: ...
...
class Section(lief.Section):
    ...
    def __contains__(self, arg: lief.MachO.SECTION_FLAGS, /) -> bool: ...
    def __iadd__(self, arg: lief.MachO.SECTION_FLAGS, /) -> lief.MachO.Section: ...
    def __isub__(self, arg: lief.MachO.SECTION_FLAGS, /) -> lief.MachO.Section: ...
    @property
...
class VM_PROTECTIONS:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @staticmethod
    def from_value(arg: int, /) -> lief.MachO.VM_PROTECTIONS: ...
    @property
    def value(self) -> int: ...
